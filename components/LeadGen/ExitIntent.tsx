...
const ExitIntent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Mobile: History back gesture (simulated with scroll velocity or inactivity)
    // Actually tracking exit on mobile is hard, but we can trigger after some scroll + inactivity or back button
      ...
      <div className="w-full max-w-xl glass md:rounded-[40px] rounded-t-[32px] border-warning/20 overflow-hidden relative p-8 md:p-16 text-center shadow-2xl animate-in slide-in-from-bottom duration-500">
        ...
        <div className="glass p-6 md:p-10 rounded-[2rem] border-white/5 mb-8 flex flex-col items-center">
            ...
            <div className="w-full space-y-4">
                ...
                <button className="w-full h-16 rounded-xl bg-warning text-space font-bold text-lg hover:scale-105 active:scale-95 transition-all shadow-xl shadow-warning/20">
